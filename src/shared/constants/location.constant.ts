...
export const STATE: Record<(typeof STATES)[number], string> = {
  AC: 'Acre',
  AL: 'Alagoas',
  AP: 'Amapá',
  AM: 'Amazonas',
...
export const CITIES_BY_STATE: Record<(typeof STATES)[number], string[]> = {
  AC: [
    'Acrelândia',
    'Assis Brasil',
    'Brasiléia',
...
@ValidatorConstraint({ name: 'CityMatchesState', async: false })
export class CityMatchesStateConstraint
  implements ValidatorConstraintInterface
{
  ...
  defaultMessage(args: ValidationArguments) {
    const object = args.object as any;
    return `City ${object.city} is not valid for state ${object.state}`;
  }
}
